...
function [bestnest,fmin]=cuckoo_search_new(SearchAgents_no,Max_iteration,lb,ub,dim,fobj);
%(inp)
n=SearchAgents_no;             % Population size
N_IterTotal=Max_iteration;   % Change this if you want to get better results
pa=0.25;              % Discovery rate of alien eggs/solutions
%dim=15;                % Dimensions of the problem
